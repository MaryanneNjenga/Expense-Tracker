document.addEventListener('DOMContentLoaded', async function () {
    try {
        ...
        expenses.forEach(expense => {
            ...
            // Apply formatDate to expense.expense_date
            ...
            row.innerHTML = `
                ...
                <td>${expense.notes || ''}</td>
                <td>
                    <button class="edit-button" data-id="${expense.expense_id}">Edit</button>
                    <button class="delete-button" data-id="${expense.expense_id}">Delete</button>
                </td>
            `;
